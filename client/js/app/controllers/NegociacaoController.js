class NegociacaoController {
    ...
    constructor() {
        ...
        this._list = new Bind(new NegotiationList(), new NegotiationsView(qS(".negotiationsView")), 'addNegotiation', 'flush')
        this._message = new Bind(new Message(), new MessageView(qS('.messageView')), 'text')
    ...
    negotiationImport() {
        ...
        Promise.all([
            ...
            .then(negotiations => {
                negotiations.reduce((flatArray, array) =>
                    flatArray.concat(array), [])
                .forEach(negotiation => this._list.addNegotiation(negotiation))
